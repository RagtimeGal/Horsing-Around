...
execute if entity @s[predicate=hoar:entity_properties/is_jousting,scores={hoar.warped_fungus_on_a_stick=1..}] if score @s hoar.horse_data matches 500.. run function hoar:item/lance/main

## Glue
execute if entity @s[predicate=hoar:entity_properties/holding_glue,scores={hoar.warped_fungus_on_a_stick=1..}] run function hoar:item/glue/main
